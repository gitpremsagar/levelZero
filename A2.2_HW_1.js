...
console.log("Is Akshay faster than Ravi in 100m sprint? ", isAkshayFaster);

console.log("---- ---- ----");

console.log("1.2");
let akshayTime400 = 46.21;
let raviTime400 = 47.01;
...
let raviDistaneShotPut = 18.92;

let isAskshayLongerShotPut = akshayDistanceShotPut > raviDistaneShotPut;
console.log(
  "Did Akshay make a longer throw than Ravi? ",
  isAskshayLongerShotPut
);
...
let areBothUnderBudget = totalPrice < budget;
console.log(
